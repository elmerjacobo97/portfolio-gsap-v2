...
export const projects: readonly Project[] = [
  {
    ...
    order: 1,
    year: 2026,
    client: { es: "Open source · InsForge", en: "Open source · InsForge" },
    liveUrl: "https://forge.elmerjacobo.dev/",
    repoUrl: "https://github.com/elmerjacobo97/forge",
    stack: [
      "Next.js",
      "React",
      "TypeScript",
