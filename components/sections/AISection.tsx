		...
		>
			<div className="grid-page py-[var(--spacing-section)]">
				...
				<div className="col-span-12 mt-16 grid gap-y-12 md:mt-20 lg:grid-cols-12 lg:gap-x-[var(--spacing-gutter)]">
					...
					<div className="border-rule bg-surface-inset relative col-span-12 overflow-hidden border-x border-b lg:col-span-7 lg:col-start-6 lg:border-t lg:border-l-0">
