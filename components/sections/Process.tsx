	...
	useGSAP(
		() => {
			...
			mm.add(DESKTOP, () => {
				...
				const progress =
					rootRef.current?.querySelector<HTMLElement>(".process-progress");
	...
	return (
		...
		>
					...
					{processSteps.map((step) => (
						...
						>
							...
							<div className="process-copy col-span-12 mt-8 md:col-span-6 md:col-start-2 md:mt-0">
								...
								<p className="text-lead text-text-secondary mt-5 max-w-[48ch]">
									{t(step.body, locale)}
								</p>
							</div>
            ...
            viewport, 1px reads as an artifact rather than a readout. */}
				...
				>
					<span
						className="process-progress bg-accent-fill block h-full w-full origin-left"
