...
export function Cursor() {
	...
	return (
		<div
			 ...
			 */
			className="cursor-dot bg-accent-fill pointer-events-none fixed top-0 left-0 z-[80] hidden size-3 -translate-x-1/2 -translate-y-1/2 rounded-full mix-blend-difference [@media(pointer:fine)_and_(prefers-reduced-motion:no-preference)]:block"
		/>
	);
}
